...
class CPB_Item_Figure extends CPB_Item {
	
	protected $name = 'Figure/Caption';
	
	protected $slug = 'figure';
	...
	protected function css() {
		...
		$style = '.cpb-figure {box-sizing:box-sizing:border-box;padding: 0.5rem;border:1px solid #ddd;background:#fff;margin-bottom:1rem;}';
		
		$style .= '.cpb-figure figcaption {padding: 0.25rem 0 0.5rem;font-size:0.8rem;}';
