...
class CAHNRS_Pagebuilder_Plugin {
	...
	**/ 
	...
	public function admin_scripts(){
		...
		wp_enqueue_style( 'admin_css', get_site_url() . '?cpb-get-template=stylesheet&cpb-stylesheet=admin&codes=' . implode( '_' , $params ) , false , '0.0.1' );
		
		wp_enqueue_script( 'admin_js', plugin_dir_url( __FILE__ ) . 'js/admin.js' , array('jquery-ui-draggable','jquery-ui-droppable','jquery-ui-sortable') , '0.0.2' , true );
