...
class CAHNRS_Pagebuilder_Plugin {
	...
	**/ 
	...
	public function admin_scripts(){
		...
		wp_enqueue_style( 'cpb_admin_css', get_site_url() . '/?cpb-get-template=stylesheet&cpb-stylesheet=admin&codes=' . implode( '_' , $params ) , false , '0.0.4' );
		
		wp_enqueue_script( 'cpb_admin_js', plugin_dir_url( __FILE__ ) . 'js/admin.js' , array('jquery-ui-draggable','jquery-ui-droppable','jquery-ui-sortable') , '0.0.4' , true );
	...
	public function public_scripts(){
		...
		wp_enqueue_style( 'cpb_public_css', plugin_dir_url( __FILE__ ) . 'css/public.css' , false , '0.0.7' );
